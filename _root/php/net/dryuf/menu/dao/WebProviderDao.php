...
interface WebProviderDao extends \net\dryuf\dao\DynamicDao
{
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\menu\WebProvider')
	*/
	...
	*/
	...
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\util\Listable<net\dryuf\menu\WebProvider>')
	*/
	function			listAll();
	...
	*/
	...
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\core\EntityHolder<net\dryuf\menu\WebProvider>')
	*/
