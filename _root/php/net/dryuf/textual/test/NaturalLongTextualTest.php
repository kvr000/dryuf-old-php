...
*/
class NaturalLongTextualTest extends \net\dryuf\textual\test\TextualsTestBase
{
	/**
	*/
	function			__construct()
	{
		parent::__construct('net\dryuf\textual\NaturalLongTextual');
	}
	...
	*/
	public function			testCorrect()
	{
		...
		\net\dryuf\tenv\DAssert::assertNotNull($this->textual->check("123.456", null));
		\net\dryuf\tenv\DAssert::assertNotNull($this->textual->check("123a456", null));
		\net\dryuf\tenv\DAssert::assertNotNull($this->textual->check("-1", null));
	...
	*/
	...
	{
		\net\dryuf\tenv\DAssert::assertEquals("123456", $this->textual->format(123456, null));
	}
