...
*/
class DotIdentifierTextualTest extends \net\dryuf\textual\test\TextualsTestBase
{
	/**
	*/
	function			__construct()
	{
		parent::__construct('net\dryuf\textual\DotIdentifierTextual');
	}
	...
	*/
	public function			testFormat()
	{
		...
		\net\dryuf\tenv\DAssert::assertEquals("hello.world", $this->textual->format("hello.world", null));
	}
