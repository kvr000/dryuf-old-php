...
class DataPresenter_ModeEdit extends \net\dryuf\datagrid\DataPresenter_ModeSingle
{
	...
	*/
	...
	{
		\net\dryuf\datagrid\DataPresenter_ModeEdit::createSubPresenter('net\dryuf\mvp\jsuse\dryuf\DryufJsRegister', $this, \net\dryuf\core\Options::$NONE)->prepare();
		parent::prepare();
	}
