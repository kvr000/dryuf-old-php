	...
	*/
	public function			readBase()
	{
		if (!is_null($this->galleryDoc))
			return;
		$this->galleryDoc = new \DOMDocument();
		$this->galleryDoc->loadXML(stream_get_contents($this->callerContext->getBeanTyped("resourceResolver", 'net\dryuf\io\ResourceResolver')->getMandatoryResourceAsStream($this->galleryDir."gallery.xml")));
