...
@\net\dryuf\meta\ActionDefs(actions = {
	@\net\dryuf\meta\ActionDef(name = "submit", isStatic = false, formActioner = ".performSubmit", roleAction = "guest")
})
...
@\javax\persistence\Table(name = "WeddingGiftsCoordinatorForm")
*/
class WeddingGiftsCoordinatorForm extends \net\dryuf\core\Object
{
	/**
	*/
