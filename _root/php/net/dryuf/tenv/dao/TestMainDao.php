...
namespace net\dryuf\tenv\dao;


interface TestMainDao extends \net\dryuf\dao\DynamicDao
{
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\tenv\TestMain')
	*/
	...
	*/
	...
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\util\Listable<net\dryuf\tenv\TestMain>')
	*/
	function			listAll();
	...
	*/
	...
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\core\EntityHolder<net\dryuf\tenv\TestMain>')
	*/
