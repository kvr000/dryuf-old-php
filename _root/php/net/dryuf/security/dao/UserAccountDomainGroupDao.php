...
interface UserAccountDomainGroupDao extends \net\dryuf\dao\DynamicDao
{
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\security\UserAccountDomainGroup')
	*/
	...
	*/
	...
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\core\EntityHolder<net\dryuf\security\UserAccountDomainGroup>')
	*/
	...
	*/
	...
	@\net\dryuf\core\Type(type = 'long')
	*/
	function			initUserWithDefaultGroups($userId, $domain);

	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\util\Collection<java\lang\String>')
	*/
	function			listGroupRolesForUserDomain($userId, $domain);
};
