...
interface AppDomainDefDao extends \net\dryuf\dao\DynamicDao
{
	/**
	...
	*/
	...
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\util\Listable<net\dryuf\security\AppDomainDef>')
	*/
	function			listAll();
	...
	*/
	...
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\core\EntityHolder<net\dryuf\security\AppDomainDef>')
	*/
	...
	*/
	...
	@\net\dryuf\core\Type(type = 'net\dryuf\security\AppDomainDef')
	*/
	function			loadByAlias($domainAlias);
};
