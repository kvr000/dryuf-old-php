...
class RoleDaoAccessJpa extends \net\dryuf\core\Object
{
	...
	*/
	public function			createRoleProcessor($baseContext)
	{
		...
		if (!is_null($roleProcessorUse)) {
			$roleProc = \net\dryuf\core\Dryuf::createObjectArgs(\net\dryuf\core\Dryuf::getConstructor($roleProcessorUse->roleProcessor(), 'net\dryuf\core\CallerContext', 'java\lang\Class'), $baseContext, $this->dataClass);
		}
		else {
	...
	*/
	...
	{
		if ((=f_I_x=)Boolean.class.isAssignableFrom(clazz)(=x_I_f=)) {
			return \net\dryuf\core\Dryuf::invokeMethod(\net\dryuf\core\Dryuf::getClassMethod($clazz, "valueOf", 'string'), null, strval($data));
		}
		elseif ((=f_I_x=)Number.class.isAssignableFrom(clazz)(=x_I_f=)) {
			return \net\dryuf\core\Dryuf::invokeMethod(\net\dryuf\core\Dryuf::getClassMethod($clazz, "valueOf", 'string'), null, strval($data));
		}
