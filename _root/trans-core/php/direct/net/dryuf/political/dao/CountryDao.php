...
interface CountryDao extends \net\dryuf\dao\DynamicDao
{
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\political\Country')
	*/
	...
	*/
	...
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\util\Listable<net\dryuf\political\Country>')
	*/
	function			listAll();
	...
	*/
	...
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\core\EntityHolder<net\dryuf\political\Country>')
	*/
