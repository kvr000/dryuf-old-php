...
namespace net\dryuf\comp\devel\dao;


interface DevelFileDao extends \net\dryuf\dao\DynamicDao
{
	/**
	...
	*/
	...
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\util\Listable<net\dryuf\comp\devel\DevelFile>')
	*/
	function			listAll();
	...
	*/
	...
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\core\EntityHolder<net\dryuf\comp\devel\DevelFile>')
	*/
