...
interface WeddingGiftsGiftDao extends \net\dryuf\dao\DynamicDao
{
	/**
	...
	*/
	...
	@\net\dryuf\core\Type(type = 'boolean')
	*/
	function			setReservedCode($weddingGiftsId, $displayName, $reservedCode);

	/**
	@\net\dryuf\core\Type(type = 'boolean')
	*/
	function			revertReservedCode($weddingGiftsId, $displayName, $reservedCode);
};
