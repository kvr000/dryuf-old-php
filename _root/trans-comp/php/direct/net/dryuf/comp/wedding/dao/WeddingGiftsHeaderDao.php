...
namespace net\dryuf\comp\wedding\dao;


interface WeddingGiftsHeaderDao extends \net\dryuf\dao\DynamicDao
{
	/**
	...
	*/
	...
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\util\Listable<net\dryuf\comp\wedding\WeddingGiftsHeader>')
	*/
	function			listAll();
