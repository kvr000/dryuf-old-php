...
namespace net\dryuf\comp\rating\dao;


interface RatingRecordDao extends \net\dryuf\dao\DynamicDao
{
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\comp\rating\RatingRecord')
	*/
	...
	*/
	...
	/**
	@\net\dryuf\core\Type(type = 'net\dryuf\core\EntityHolder<net\dryuf\comp\rating\RatingRecord>')
	*/
	...
	*/
	...
	@\net\dryuf\core\Type(type = 'void')
	*/
	function			addRatingValue($pollId, $userId, $value);
};
